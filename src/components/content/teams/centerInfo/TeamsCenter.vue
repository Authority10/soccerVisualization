...
<script>
  ...
  export default {
    ...
    computed:{
      ...
      teamMatches(){
        return this.singleTeam.teamMatches
      }
    },
    //利用watch监听props变化
    watch:{
    ...
    mounted() {
      ...
      this.$store.subscribe((mutation, state) => {
        this.singleTeam = state.singleTeam
      })
